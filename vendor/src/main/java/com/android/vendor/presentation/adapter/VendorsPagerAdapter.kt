package com.android.vendor.presentation.adapter
...
import com.android.vendor.databinding.ListItemVendorCategoryContentBinding
import com.android.vendor.domain.model.VendorsDomainModel

class VendorsPagerAdapter(private val listener: OnItemClickListener) : PagingDataAdapter<VendorsDomainModel, VendorsPagerAdapter.ViewHolder>(
    ItemCallback
) {
